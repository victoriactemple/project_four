...
// To clear the server-side data, we'll simply make a DELETE request to the Devise /auth/sign_out endpoint. On the client side, we'll use a final helper function:
